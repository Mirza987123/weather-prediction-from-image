...
vd = T.separate_data(validation_data, validation_label)  # Separate validation data and labels into classes  # Separate validation data and labels into classes  # Separate validation data and labels into classes  # Separate validation data and labels into classes
