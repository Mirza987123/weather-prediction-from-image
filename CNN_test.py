...
validation_label = np_utils.to_categorical(validation_label, num_classes)  # Convert labels to categorical format  # Convert labels to categorical format  # Convert labels to categorical format  # Convert labels to categorical format
